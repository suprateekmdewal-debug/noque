    ...
    <footer className="bg-[#0a0a0a] border-t border-[#262626] py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          {/* Brand */}
          <div>
            <span className="font-syne font-bold text-2xl gradient-text">NOQ</span>
            <p className="text-[#a3a3a3] text-sm mt-2 leading-relaxed font-dm-sans">
              Skip the Queue. Book Your Slot.
            </p>
            <p className="text-[#666] text-xs mt-3 font-dm-sans">
              A FutureUnboxxed India Brand
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="font-syne font-semibold text-sm text-[#f5f5f5] mb-4 uppercase tracking-wider">Pages</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#a3a3a3] hover:text-white text-sm transition-colors font-dm-sans"
                  >
                    {link.label}
                  </Link>
                </li>
